...
#let lines = (
  line(
    ...
    station([安德门], [ANDEMEN], y: -5.25, marker-rotation: -45deg),
    pin-round(x: -2., d: SW),
  ...
  line(
    ...
    station([江北市民中心], [JIANGBEISHIMINZHONGXIN], y: 5.25, marker-rotation: 45deg),
  ...
  line(
    ...
    station([摄山], [SHESHAN], r: 1.0, anchor: N, logo-anchor: S, marker-rotation: 90deg),
    pin(x: 19.0, d: E),
  ),
  line(
    number: "7",
  ...
  line(
    ...
    station([仙林站], [XIANLINZHAN], marker-rotation: -45deg),
  ...
  line(
    ...
    station([刘村], [LIUCUN], logo-anchor: SE, marker-rotation: -45deg),
  ...
  line(
    ...
    station([东麒路], [DONGQILU], marker-rotation: 90deg, logo-anchor: NE),
    pin(x: 9.5, d: E),
  ),
  line(
    number: "11",
  ...
  line(
    ...
    station([南京农业大学], [NANJINGNONGYEDAXUE], x: 6.0, marker-rotation: 90deg),
    pin-round(x: 6.5, d: E),
  ...
  line(
    ...
    station([禄口机场], [LUKOUJICHANG], logo-anchor: N, marker-rotation: 90deg),
    pin(x: 1.0, d: E),
  ),
  line(
    number: "S1",
  ...
  line(
    ...
    station([东郊小镇], [DONGJIAOXIAOZHEN], x: 15.0, marker-rotation: 90deg),
