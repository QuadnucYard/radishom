...
#let lines = (
  line(
    ...
    station([南京南站], [NANJING SOUTH RAILWAY STATION], y: -8., anchor: "north-west"),
  ...
  line(
    ...
    station([江北商务区], [JIANGBEISHANGWUQU], anchor: "west"),
  ...
  line(
    ...
    pin(x: -0.5, d: dirs.south-west),
    station([翠屏山], [CUIPINGSHAN], y: -11., anchor: "east"),
