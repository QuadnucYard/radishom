...
#let lines = (
  line(
    ...
    pin-round(y: -7., d: S),
    station([软件大道], [RUANJIANDADAO], x: -1., marker-rotation: 90deg),
    ...
    station([百家湖], [BAIJIAHU], y: -12.75, marker-rotation: 0deg),
    pin-round(y: -13., d: S),
  ...
  line(
    ...
    station([鱼嘴], [YUZUI], marker-rotation: 90deg, logo-anchor: E),
    ...
    station([集庆门大街], [XINGLONGDAJIE], y: -2, marker-rotation: 0deg, cfg-not: "no-jqmdj"),
    pin-round(y: -1, d: N),
    station([云锦路], [YUNJINLU]),
    pin-round(x: -3.25, d: E),
    station([莫愁湖], [MOCHOUHU], x: -3., marker-rotation: 90deg),
    pin-round(y: 0., d: NE),
    ...
    station([马群], [MAQUN], x: 10.0, marker-rotation: 90deg),
    pin-round(x: 11., d: E),
  ...
  line(
    ...
    station([柳洲东路], [LIUZHOUDONGLU], marker-rotation: -45deg),
  ...
  line(
    ...
    station([江北市民中心], [JIANGBEISHIMINZHONGXIN], y: 5.25, anchor: W, marker-rotation: 45deg),
    ...
    pin-round(x: 2.5, d: E),
    station([岗子村], [GANGZICUN], y: 2.75, marker-rotation: -45deg),
  ...
  line(
    ...
    pin-round(x: 3., d: NW),
    station([红山新城], [HONGSHANXINCHENG], y: 6., marker-rotation: 0deg),
    pin-round(y: 6.5, d: N),
    ...
    station([摄山], [], r: 1.0, anchor: N, logo-anchor: S, marker-rotation: 90deg),
    pin(x: 19.0, d: E),
  ),
  line(
    number: "7",
    ...
    station([西善桥], [XISHANQIAO], marker-rotation: -45deg, logo-anchor: SE),
    pin(y: -10. + 0.07, d: SW),
  ),
  line(
    number: "8",
    ...
    station([中和桥], []),
    station([石门坎], []),
    station([胜利村], [], marker-rotation: 90deg),
    pin-round(x: 6.5, d: E),
    station([双拜岗], []),
    pin-round(dy: 1., d: NE),
    station([沧波门], []),
    ...
    station([仙林站], [], marker-rotation: -45deg),
  ...
  line(
    ...
    pin-round(y: -1., d: S),
    station([清江南路], [QINGJIANNANLU], dx: -0.5, marker-rotation: 90deg),
    pin-round(dx: -1., d: W),
    ...
    station([刘村], [], logo-anchor: SE, marker-rotation: -45deg),
    station([凤集大道], []),
    station([凤汇大道], []),
    pin-round(x: -13.5, d: SW),
    station([板桥中心], []),
    pin-round(y: -12.5, d: S),
    station([板桥], [], marker-rotation: 45deg),
    station([莲花湖公园], [], marker-rotation: 45deg, logo-anchor: NW),
    pin(x: -10.0, d: E),
  ),
  line(
    number: "10",
    ...
    station([高桥门], [GAOQIAOMEN], x: 5.75, marker-rotation: -45deg),
    pin-round(x: 6., d: NE),
    station([杨庄], [YANGZHUANG], x: 7.5),
    station([石杨路], [SHIYANGLU]),
    station([东麒路], [DONGQILU], marker-rotation: 90deg, logo-anchor: W),
    pin(x: 9.5, d: E),
  ),
  line(
    number: "11",
  ...
  line(
    ...
    station([月牙湖], [], x: 4.0),
    station([后标营], []),
    station([南京农业大学], [], x: 6.0, marker-rotation: 90deg),
    pin-round(x: 6.5, d: E),
    station([胜利村], []),
  ...
  line(
    ...
    station([绿洲], [], x: -11.5),
    station([板桥南], [], marker-rotation: 45deg, logo-anchor: NW),
    pin(x: -12.5, d: W),
  ),
  line(
    number: "18",
    ...
    station([禄口机场西], []),
    station([禄口机场], [], logo-anchor: N, marker-rotation: 90deg),
    pin(x: 1.0, d: E),
  ),
  line(
    number: "S1",
  ...
  line(
    ...
    station([东郊小镇], [], x: 15.0, marker-rotation: 90deg),
